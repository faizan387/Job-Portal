    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card" id="card">
                ...
                <form action="#" method="POST" id="employerRegisterationForm">
                    <div class="card-body">
                        ...
                        <br />
                        <div class="form-group">
                            <button class="btn btn-primary" id="employerRegistrationBtn">Register</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    let registerBtn = document.getElementById('employerRegistrationBtn').addEventListener("click", function(evt) {
        let url = "{{route('store.employer')}}";
        let form = document.getElementById('employerRegisterationForm');
